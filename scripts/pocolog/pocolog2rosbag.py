...
if __name__ == '__main__':
    ...
    parser.add_argument('--port_pose', '-pp', type=str, default='', help='Pocolog port for poses')
    parser.add_argument('--topic_pose', '-tp', type=str, default='', help='ROS topic name for poses')
